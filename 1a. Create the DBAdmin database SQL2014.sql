...
CREATE DATABASE [DBAdmin]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DBAdmin', FILENAME = N'E:\SQLDATA\Data\DBAdmin.mdf' , SIZE = 2048MB , MAXSIZE = 4096MB, FILEGROWTH = 64MB ), 
 FILEGROUP [DATA]  DEFAULT
( NAME = N'DBAdmin_Data', FILENAME = N'E:\SQLDATA\Data\DBAdmin_Data.ndf' , SIZE = 4096MB , MAXSIZE = 8192MB , FILEGROWTH = 64MB )
 LOG ON 
...
GO
ALTER DATABASE [DBAdmin] SET COMPATIBILITY_LEVEL = 120 -- change this to reflect the environment into which it is being deployed.
GO
